...
<!-- Content Wrapper. Contains page content -->
    ...
    <!-- Content Header (Page header) -->
        ...
        <div class="card mb-3 mx-auto" style="max-width: 900px";>
            ...
            <div class="card-body">
                <form action="{{ route('pengajuan.update', $getpengajuan->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <div class="row mb-3">
                      <label class="col-sm-3 col-form-label">No Kartu Keluarga</label>
                      <div class="col-sm-9">
                        <input name="kk" type="number" class="form-control" id="kk" value="{{ old('kk', $getpengajuan->kk) }}"
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-sm-9">
                        <input name="nik" type="number" class="form-control" id="nik" value="{{ old('nik', $getpengajuan->nik) }}"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                          <input name="nama" type="text" class="form-control" id="nama" value="{{ old('nama', $getpengajuan->nama) }}"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                          <input name="alamat" type="text" class="form-control" id="alamat" value="{{ old('alamat', $getpengajuan->alamat) }}"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                          <input name="tanggungan" type="number" class="form-control" id="tanggungan" value="{{ old('tanggungan', $getpengajuan->tanggungan) }}"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                          <input name="sekolah" type="number" class="form-control" id="sekolah" value="{{ old('sekolah', $getpengajuan->sekolah) }}"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                          <input name="lansia" type="number" class="form-control" id="lansia" value="{{ old('lansia', $getpengajuan->lansia) }}"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                          <input name="bumil" type="number" class="form-control" id="bumil" value="{{ old('bumil', $getpengajuan->bumil) }}"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                          <input name="disabilitas" type="number" class="form-control" id="disabilitas" value="{{ old('disabilitas', $getpengajuan->disabilitas) }}"
